...
| 平台 | 状态 | 怎么验证的 |
|---|---|---|
| **Linux** | ✅ 完整支持 | 作者实机 + GitHub Actions `ubuntu-latest` 原生 runner：40 项内核测试、17 项恶劣网络测试、7 项并发测试、167 项浏览器界面自检、真 Qt 离屏渲染 |
...
python src/eversend/web/selftest.py      # 167 项：QR/CSRF/路径穿越/Range/完整收发链路/交给手机/APK 下载/App 登记
